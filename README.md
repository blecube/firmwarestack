...
This firmware stack is written for our own PCB called BLE Card. In the preprocessor settings this card is defined. For use with a development kit BOARD_PCA10040 should be substituted with BOARD_BLECARD
